...
public class Connector<TSubject, TValidator>(TValidator left)
    ...
    public ValidationResult Result => left.Result;
    ...
    public TValidator And(Func<TValidator, ITerminator> validateRight) => ProcessAnd(validateRight, ValidatorMode.And);

    public TValidator AndNot(Func<TValidator, ITerminator> validateRight) => ProcessAnd(validateRight, ValidatorMode.AndNot);

    public TValidator Or(Func<TValidator, ITerminator> validateRight) => ProcessOr(validateRight, ValidatorMode.And);

    public TValidator OrNot(Func<TValidator, ITerminator> validateRight) => ProcessOr(validateRight, ValidatorMode.AndNot);
