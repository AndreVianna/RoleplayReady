...
public record IsLessOrEqual<TValue> : Modifier
    where TValue : IComparable<TValue> {
    public IsLessOrEqual(IHasModifiers target, string attributeName, TValue maximum, string message, ValidationSeverityLevel severityLevel = Hint)
        : base(target, e => {
