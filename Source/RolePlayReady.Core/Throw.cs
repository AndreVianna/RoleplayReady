...
public static class Throw {
    ...
    public static TObject IfNull<TObject>([NotNull] TObject? argument, string? message = null, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        => argument is null
            ? throw new ArgumentNullException(paramName, GetMessageOrDefault(message, _nullValueMessage))
            : argument;

    public static IEnumerable<TItem> IfNullOrEmpty<TItem>([NotNull] IEnumerable<TItem>? argument, string? message = null, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
    ...
    public static IEnumerable<TItem> IfNullOrEmptyOrContainNulls<TItem>([NotNull] IEnumerable<TItem?>? argument, string? message = null, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        => argument is not ICollection<TItem> collection || collection.Count == 0
            ? ThrowArgumentException<IEnumerable<TItem>>(message, _emptyCollectionMessage, paramName)
    ...
    public static string IfNullOrEmpty([NotNull] string? argument, string? message = null, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
        => string.IsNullOrEmpty(argument)
            ? ThrowArgumentException<string>(message, _nullOrEmptyMessage, paramName)
            : argument;

    public static string IfNullOrWhiteSpaces([NotNull] string? argument, string? message = null, [CallerArgumentExpression(nameof(argument))] string? paramName = null)
