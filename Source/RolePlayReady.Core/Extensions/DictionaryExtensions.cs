...
public static class DictionaryExtensions {
    ...
    public static IConnectors<IDictionary<TKey, TValue?>, DictionaryValidators<TKey, TValue>> CheckIfEach<TKey, TValue>(this IDictionary<TKey, TValue?>? subject, Func<TValue?, ITerminator> validate, [CallerArgumentExpression(nameof(subject))] string? source = null)
        where TKey : notnull
