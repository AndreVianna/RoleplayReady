...
public class GameSystemsRepository : IGameSystemsRepository {
    ...
    public async Task<Object<IEnumerable<GameSystem>>> GetManyAsync(string owner, CancellationToken cancellation = default) {
    ...
    public async Task<Object<GameSystem>> InsertAsync(string owner, GameSystem input, CancellationToken cancellation = default) {
    ...
    public async Task<Object<GameSystem>> UpdateAsync(string owner, GameSystem input, CancellationToken cancellation = default) {
