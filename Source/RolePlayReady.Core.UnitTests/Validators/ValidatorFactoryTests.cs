...
public class ValidatorFactoryTests {
    ...
    private class TestData : TheoryData<Type, string, Type, object[]> {
        public TestData() {
            ...
            Add(typeof(string), nameof(IsOneOf), typeof(IsOneOf), new object[] { "Abc", "Def" });
            ...
            Add(typeof(List<int>), nameof(NotContains<int>), typeof(NotContains<int>), new object[] { 20 });
            Add(typeof(List<int>), nameof(Contains<int>), typeof(Contains<int>), new object[] { 20 });
