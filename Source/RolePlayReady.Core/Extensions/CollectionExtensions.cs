...
public static class CollectionExtensions {
    ...
    public static IConnectors<ICollection<TItem?>, CollectionValidators<TItem>> CheckIfEach<TItem>(this ICollection<TItem?> subject, Func<TItem?, ITerminator> validateItem, [CallerArgumentExpression(nameof(subject))] string? source = null)
