...
//            nameof(GameSetting.PowerSources) => nameof(PowerSource),
...
//            nameof(GameSetting.PowerSources) when Target is GameSetting ruleSet => ruleSet.PowerSources.FirstOrDefault(i => i.Name == existing),
//            _ => throw new NotImplementedException()
//        };
...
//                return;
//            case GameSetting ruleSet when item is PowerSource powerSource:
...
//                return;
//            case nameof(GameSetting.PowerSources) when Target is GameSetting ruleSet:
