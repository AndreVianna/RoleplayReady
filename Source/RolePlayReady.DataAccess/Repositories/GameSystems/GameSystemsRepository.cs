...
public class GameSystemsRepository : IGameSystemsRepository {
    ...
    public async Task<ResultOf<IEnumerable<GameSystem>>> GetManyAsync(string owner, CancellationToken cancellation = default) {
    ...
    public async Task<ResultOf<GameSystem>> GetByIdAsync(string owner, Guid id, CancellationToken cancellation = default) {
    ...
    public async Task<ResultOf<GameSystem>> InsertAsync(string owner, GameSystem input, CancellationToken cancellation = default) {
    ...
    public async Task<ResultOf<GameSystem>> UpdateAsync(string owner, GameSystem input, CancellationToken cancellation = default) {
