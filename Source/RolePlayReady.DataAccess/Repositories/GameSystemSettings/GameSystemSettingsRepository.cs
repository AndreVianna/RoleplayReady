...
public class GameSystemSettingsRepository : IGameSystemSettingsRepository {
    ...
    public async Task<ObjectResult<IEnumerable<GameSystemSetting>>> GetManyAsync(string owner, CancellationToken cancellation = default) {
    ...
    public async Task<NullableResult<GameSystemSetting>> GetByIdAsync(string owner, Guid id, CancellationToken cancellation = default) {
    ...
    public async Task<ObjectResult<GameSystemSetting>> InsertAsync(string owner, GameSystemSetting input, CancellationToken cancellation = default) {
    ...
    public async Task<ObjectResult<GameSystemSetting>> UpdateAsync(string owner, GameSystemSetting input, CancellationToken cancellation = default) {
