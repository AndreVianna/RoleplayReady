...
public static class ValidationExtension {
    ...
    public static StringsValidator ListIs(this IList<string> subject, [CallerArgumentExpression(nameof(subject))] string? source = null)
        => new(subject, source);
    public static IStringsConnectors ItemIs(this IList<string> subject, Func<StringValidator, IStringConnectors> validate, [CallerArgumentExpression(nameof(subject))] string? source = null)
        => new StringsValidator(subject, source).EachItemIs(validate);
}